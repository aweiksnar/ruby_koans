...
class AboutSymbols < Neo::Koan
  ...
  # => Comparing two symbols tests if they have the same object_id, comparing two strings tests if they are equivalent
  ...
  # => they take up extra memory and can not be modified
end
