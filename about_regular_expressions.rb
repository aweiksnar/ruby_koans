...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # => when looking for another splat, ex: abbcccddddeeeee"[/**/], or in an array/hash object
  end
  ...
  #
  # Why?
  # => they only grab the first matching expression, even if there are 'better' matches
  ...
  # => alterations check for specific instances, the character class iterates on a character lever
  # ------------------------------------------------------------------
